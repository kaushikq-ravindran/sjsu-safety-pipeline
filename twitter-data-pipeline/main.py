...
class TwitterETL:
    ...
    def __init__(self):
        ...
        self.raw_data_bucket_name = '<your_raw_data_bucket_name>' # eg:- "kaushikq-sjsu-raw-data-bucket"
        self.processed_data_bucket_name = '<your_processed_data_bucket_name>' # eg:- "kaushikq-sjsu-processed-data-bucket"
    ...
    def construct_query(self):
        ...
        query = f'SJSU lang:en until:{today} since:{yesterday} -filter:replies'
